...
namespace Game.Tests.EditMode.Enemy
{
    ...
    public class EnemyMoverTests
    {
        ...
        public void 초기_Position은_startPosition이다()
        {
            ...
            var mover = new EnemyMover(5f, start);
        ...
        {
            var mover = new EnemyMover(speed: 0f);
        ...
        {
            var mover = new EnemyMover(speed: -10f);
        ...
        {
            var mover = new EnemyMover(speed: 5f);
            mover.Move(Vector2.right, deltaTime: 1f);
        ...
        public void 대각선_이동은_normalized_속도를_유지한다()
        {
            ...
            Assert.AreEqual(5f, mover.Position.magnitude, delta: 0.001f);
        }
        ...
        {
            var mover1 = new EnemyMover(speed: 5f);
            var mover2 = new EnemyMover(speed: 5f);
